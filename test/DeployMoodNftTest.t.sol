...
contract DeployMoodNftTest is Test {
    ...
    function testConvertSvgToUri() public view {
        ...
        string
            memory svg = '<svg xmlns="http://www.w3.org/2000/svg" width="500" height="500"><text x="0" y="15" fill = "black"> Hi! your browser decode this! </text></svg>';
        string memory actualUri = deployer.svgToImageURIs(svg);
        assert(
